...
N8_Image = np.zeros((N_Image.shape[0] + 2, N_Image.shape[1] + 2))   # Add zero padding to the input image
N8_Image[1:-1, 1:-1] = np.copy(N_Image)
...
N8_Image=N8_Image[1:-1, 1:-1] #removing zero padding
